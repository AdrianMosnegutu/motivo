...
\begin{figure}[p]
  ...
  \caption{Motivo Studio after a successful local compile of \texttt{example.motivo}: Monaco editor, success log,
  playback controls, and piano-roll visualization.}\label{fig:studio-success-screenshot}
\end{figure}
