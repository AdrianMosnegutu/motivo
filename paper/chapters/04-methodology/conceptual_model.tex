...
\subsection{Linear vs. Structural Representation}\label{subsec:linear-vs.-structural-representation}
...
\subsection{Music as a Pure Function}\label{subsec:music-as-a-pure-function}
...
Just as a function in programming can be called multiple times with different arguments, a musical pattern in the
proposed DSL can be instantiated across different tracks, at different times, or with different parameters (such as
