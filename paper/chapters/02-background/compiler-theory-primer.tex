...
Mernik, Heering, and Sloane survey the decision in more detail, cataloguing when a DSL is justified and the
implementation patterns available once it is~\cite{Mernik_Heering_Sloane_2005}.
