...
\subsection{Procedural Generation vs. Direct Input}\label{subsec:procedural-generation-vs.-direct-input}
...
\subsection{Structured Abstraction}\label{subsec:structured-abstraction}
...
The DSL proposed in this thesis aims to provide a robust, type-safe environment specifically optimized for this
