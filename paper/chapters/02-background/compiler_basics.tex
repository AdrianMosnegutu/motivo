...
\subsection{Lexical and Syntactic Analysis}\label{subsec:lexical-and-syntactic-analysis}
...
\subsection{Semantic Analysis}\label{subsec:semantic-analysis}
...
Key tasks include:
\begin{itemize}
  \item \textbf{Type Checking:} Ensuring that operations are applied to compatible data types (e.g., preventing the
    addition of a boolean to a note).
  \item \textbf{Symbol Resolution:} Maintaining a \textit{Symbol Table} to ensure that variables and functions are
...
Generation}\label{subsec:intermediate-representation-and-code-generation}
