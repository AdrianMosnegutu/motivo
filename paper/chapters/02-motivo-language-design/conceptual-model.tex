...
It supports determinism because the language lacks a real-time runtime: every musical relationship, including typed
variable bindings and pattern overload resolution, is resolved at compile-time, producing a deterministic
representation in the output artifact.
