...
The value 20{,}000 is an implementation limit that stops unrolling with a diagnostic once reached; it is not a claim about
...
The AST stores statements and expressions in \texttt{std::variant} sum types with \texttt{std::visit} dispatch; recursive
