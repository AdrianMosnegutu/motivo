...
The benchmark suite exercises this boundary directly: a fixture that requests 20{,}001 events is rejected during
lowering with exactly this diagnostic, and the reproducible run asserts that rejection, so the cap is a tested behavior
...
These bounds complete the implementation-side evidence gathered in this chapter; the following section interprets the
benchmark measurements in broader context.
