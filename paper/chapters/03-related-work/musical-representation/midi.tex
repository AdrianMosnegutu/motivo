...
Despite its widespread adoption, MIDI exhibits several fundamental limitations.
...
These limitations motivate the design of the DSL proposed in this thesis, which aims to separate
compositional intent from performance encoding, provide richer abstractions for musical structure, and
improve expressiveness beyond discrete event streams.
