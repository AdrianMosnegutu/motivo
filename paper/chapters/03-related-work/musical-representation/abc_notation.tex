...
However, \textbf{ABC notation} serves a different role from the DSL proposed in this thesis.
It is effective as a notation and exchange format, but it is not intended to function as an executable, high-level
composition language.
This contrast helps clarify why the proposed DSL must combine readability with abstraction, modularity, and explicit
temporal semantics.
