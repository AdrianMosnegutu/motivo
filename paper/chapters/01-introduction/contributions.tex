...
\begin{itemize}
  ...
  \item \textbf{An empirical evaluation.}
    We measure the compiler on synthetic benchmarks and real compositions, showing that compact source expands into
    large MIDI timelines in low-millisecond compile times, with explicit typing in version~2.0 adding negligible
    overhead while producing byte-identical output.
\end{itemize}
