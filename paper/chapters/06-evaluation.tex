...
\input{chapters/06-evaluation/sections/methodology}
\input{chapters/06-evaluation/sections/compilation-time}
\input{chapters/06-evaluation/sections/source-to-event-expansion}
\input{chapters/06-evaluation/sections/current-limits}
\input{chapters/06-evaluation/sections/testing-evidence}
\input{chapters/06-evaluation/sections/comparative-interpretation}
\input{chapters/06-evaluation/sections/evaluation-summary}
