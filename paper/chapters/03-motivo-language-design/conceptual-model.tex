...
script.
Motivo instead treats a piece as a \textit{recursive hierarchy}---notes grouped into patterns, patterns sequenced
in tracks, optional voices for parallel lines within a track---so musical content (the ``what'') stays separate from
scheduling (the ``when'').
