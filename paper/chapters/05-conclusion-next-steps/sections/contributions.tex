...
full event timeline described in Chapters~\ref{ch:language-compiler} and~\ref{ch:evaluation}.
...
Chapter~\ref{ch:language-compiler} documents this evolution; Chapter~\ref{ch:evaluation} shows that the stricter model
...
and paper CI workflows (Section~\ref{sec:testing-ci}).
