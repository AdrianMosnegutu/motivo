...
\begin{table}[htbp]
  ...
  \begin{tabular}{p{1.2cm}p{4.5cm}p{7.5cm}}
    ...
    addresses \\
    2 & Design of the Motivo language &
    Grammar, type system, semantic rules, temporal model, and compilation strategy at specification level \\
    3 & Implementation of the Motivo compiler &
    Pipeline architecture, frontend, semantic pass, lowering, and MIDI backend in C++ \\
    4 & Motivo Studio: web editor and client &
    Application architecture, compile API flow, Monaco editor, piano roll, playback, auth, and files \\
    5 & Deployment, testing, and CI/CD &
    Docker and Railway deployment, Cloudflare TLS, automated tests, and CI-gated promotion \\
...
Chapters~\ref{ch:language-design} and~\ref{ch:compiler-implementation} form the technical core: the former specifies
what Motivo is; the latter explains how \texttt{motivoc} is built.
Chapter~\ref{ch:studio-editor} treats the web editor as an integral product artifact; Chapter~\ref{ch:deployment-ci}
documents testing, deployment, and operations.
